...
var ScrollView = (0, _coreDecorators.autobind)(_class = (_temp = _class2 = /*#__PURE__*/function (_Component) {
  ...
  _createClass(ScrollView, [{
    ...
    value: function initEvent() {
      this.scroll.on(_index.Event.pullUp, this.pullUp);
      this.scroll.on(_index.Event.pullingDown, this.pullingDown);
      this.scroll.on(_index.Event.pullDown, this.pullDown);
      this.scroll.on(_index.Event.cancelPullDown, this.cancelPullDown);
    }
  }, {
    key: "cancelPullDown",
              ...
              case 0:
                errorPromise = new Promise(function (resolve, reject) {
                  ...
                  _this5.requestErrorTimer = window.setTimeout(function () {
                    _index.Scroll.info('request callback error');
  ...
  return ScrollView;
}(_react.Component), _defineProperty(_class2, "defaultProps", defaultProps), _temp)) || _class;
